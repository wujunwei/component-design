...
import (
	...
	"github.co/wujunwei/component-design/controllers"
...
func init() {
	...
	utilruntime.Must(designv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "592a6d70.design.component.io",
	})
	if err != nil {
	...
	if err = (&controllers.TraitDefineReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "TraitDefine")
		os.Exit(1)
	}
